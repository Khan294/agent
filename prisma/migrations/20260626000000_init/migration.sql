...
CREATE INDEX "rag_documents_agent_key_idx" ON "rag_documents"("agent_key");
...
ALTER TABLE "rag_documents" ADD CONSTRAINT "rag_documents_agent_key_fkey" FOREIGN KEY ("agent_key") REFERENCES "agents"("agent_key") ON DELETE CASCADE ON UPDATE CASCADE;
